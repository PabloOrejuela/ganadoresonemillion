<link rel="stylesheet" href="<?= site_url(); ?>public/css/navbar.css">
<!--begin::App Wrapper-->
    ...
    <nav class="app-header navbar navbar-expand bg-body">
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-md-block"><a href="<?= site_url() ?>contactos" class="nav-link">Contactos</a></li>
          <li class="nav-item d-none d-md-block"><a href="<?= site_url() ?>recursos" class="nav-link">Recursos</a></li>
        </ul>
    ...
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
      ...
      <div class="sidebar-brand">
        ...
        <a href="<?= site_url(); ?>" class="brand-link">
          <!--begin::Brand Image-->
          <img
            src="<?= site_url(); ?>public/images/isotipo-gom.png"
            alt="Logo"
