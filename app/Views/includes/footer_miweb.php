			<!-- Footer -->
				<div id="footer-wrapper">
					...
					<div id="copyright" class="container">
						<ul class="menu">
							<li>&copy; Todos los derechos reservados.</li><li>Diseñado por: <a href="<?= site_url(); ?>"><?= NOMBRE_EMPRESA; ?></a></li>
						</ul>
					</div>
				</div>
		...
		<!-- Scripts -->
			...
			<script src="<?= site_url(); ?>public/mi-web/assets/js/jquery.dropotron.min.js"></script>
			<script src="<?= site_url(); ?>public/mi-web/assets/js/browser.min.js"></script>
			<script src="<?= site_url(); ?>public/mi-web/assets/js/breakpoints.min.js"></script>
			<script src="<?= site_url(); ?>public/mi-web/assets/js/util.js"></script>
			<script src="<?= site_url(); ?>public/mi-web/assets/js/main.js"></script>
