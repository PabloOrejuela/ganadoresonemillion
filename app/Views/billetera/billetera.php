      ...
      <div class="row mt-2">
        <div class="card direct-chat direct-chat-primary mb-4">
          <div class="card-header">
            <h5>Ganadores One Million le da la oportunidad de usar el importe de sus BIR (Bonos de Inicio Rápido) para renovar su suscripción para usted o los miembros de su equipo. Simplemente seleccione la cantidad de dinero que desee asignar a su cuenta de crédito y este se añadirá automáticamente a su billetera cada vez que tenga uns ingreso por BIR.</h5>
